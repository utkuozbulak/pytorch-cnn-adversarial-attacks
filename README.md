...
* Fooling images (Unrecognizable images predicted as classes with high confidence) [2]
* Fooling images disguised as another image (Picture of ipod being predicted as horse) [2]

It will also include more adverisarial attack techniques and defenses in the future as well.

The code uses pretrained AlexNet in the model zoo. You can simply change it with your model but don't forget to change target class parametres as well.
